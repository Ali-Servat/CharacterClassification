...
public class MLPerceptronNetwork2 : INotifyPropertyChanged, INeuralNetwork
{
    ...
    public MLPerceptronNetwork2(int[,] trainingInputs, int[,] validationInputs, int layerCount, double learningRate, int numOfHiddenNeuronsPerLayer)
    {
